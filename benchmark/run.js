...
const suiteFork = bench.Suite()
const suiteCreate = bench.Suite()
const suiteError = bench.Suite()
...
bench
  ...
  .add('native for', function () {
    const itemList = [
      119, 201, 12, 3, 334, 14, 31, 123, 321, 23, 32, 332, 300, 1, 2,
    ]
    let i
  ...
  .add('forObjectKeys', function () {
    ...
    let res = 0
    const plist = Object.keys(itemList)
    let i
